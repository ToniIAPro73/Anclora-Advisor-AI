...
import * as generalAlertsRoute from "../src/app/api/general-alerts/route";
import * as generalAlertDetailRoute from "../src/app/api/general-alerts/[alertId]/route";
import * as generalAlertRemindersRoute from "../src/app/api/general-alert-reminders/route";
import * as generalAlertReminderDetailRoute from "../src/app/api/general-alert-reminders/[reminderId]/route";
...
async function main(): Promise<void> {
  ...
  assert(typeof generalAlertsRoute.GET === "function", "GET /api/general-alerts handler exported");
  assert(typeof generalAlertsRoute.POST === "function", "POST /api/general-alerts handler exported");
  assert(typeof generalAlertDetailRoute.PATCH === "function", "PATCH /api/general-alerts/[alertId] handler exported");
  assert(typeof generalAlertRemindersRoute.GET === "function", "GET /api/general-alert-reminders handler exported");
  assert(typeof generalAlertRemindersRoute.POST === "function", "POST /api/general-alert-reminders handler exported");
  assert(typeof generalAlertReminderDetailRoute.PATCH === "function", "PATCH /api/general-alert-reminders/[reminderId] handler exported");
  ...
  assert(typeof invoiceExportRoute.GET === "function", "GET /api/invoices/export handler exported");
